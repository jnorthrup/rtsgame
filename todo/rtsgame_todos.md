...
- Game.interpret edge cases: fixed Move command handling for entities without position components, added comprehensive edge case tests (src/commonMain/kotlin/rtsgame/core/DenseCore.kt).
