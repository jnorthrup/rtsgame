...
/**
 * Non-infix version for explicit join creation.
 */
fun <A, B> j(firstParam: A, secondParam: B): Join<A, B> = Join(firstParam, secondParam)
 ...
 */
fun <T> twin(value: T): Twin<T> = j(value, value)
